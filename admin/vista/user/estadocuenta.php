...
echo "<h1>N. de Cuenta: $numeroc&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Nombres:  $nombres&nbsp;&nbsp;$apellidos</h1>"
        ...
        <script>
function buscar(){
    var d =document.getElementById("tipo");
    var distext=d.options[d.selectedIndex].text;
    document.getElementById("txttipo").value=distext;

}

</script>
<form action = "listarestado.php" method="post" >
        <table style="width:100%" border>
                ...
                <div>
                    ...
                    <select id="tipo" name="tipo" onchange="buscar();">
                      ...
                      <input style="visibility:hidden" type="text" id="txttipo" name="txttipo"/>
                </div>
                <br> 
            <th>
              <div>
            ...
            <h3>FECHA DESDE </h3>
            <input type="date" id="fechad" id="fechad" name="fechad">
             </div>
      </th>
        <br>
                ...
                <div>
                    <h3>FECHA HASTA </h3>
                    <input type="date" id="fechah" id="fechah" name="fechah">
                </div>
            </th>
                <br>
        </table>
        <br>
        <input style="padding: 15px 80px" type="submit"  value="CONSULTAR ESTADO" name="consultar" id="consultar" >
</section>
